"""
Leaguepedia data sources — Cargo + wikitext + image lookup.

Lower half of the old monolith leaguepedia.py. Pure fetch/parse: every
function here either talks to lol.fandom.com or transforms its response
into a flat dict. Orchestration (running multi-pass syncs, persisting
to PlayerMeta) lives in `sync.py`.
